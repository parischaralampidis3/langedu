            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="rounded-md mt-5" type="text" name="firstname" id="firstname" value="{{old('firstname')}}" required/>
                        @error('firstname')
                            <p>{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="rounded-md mt-5" type="text" name="lastname" id="lastname" value="{{old('lastname')}}" required/>
                        @error('lastname')
                            <p>{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col">
                      ...
                      <button style="background-color:blue" class="mt-10 ml-10 bg-green-600 text-white font-bold py-2 px-2 hover:underline"
